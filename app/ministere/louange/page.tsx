    ...
    <div style={{ minHeight: '100vh', background: 'var(--bgLight)', padding: '2rem 0' }}>
      ...
      <div style={{ maxWidth: '1000px', margin: '0 auto', padding: '0 2rem' }}>
        ...
        <div style={{ 
          ...
          <img 
            src="/images/ministries/worship.jpg" 
            alt="Ministère Louange"
            style={{
              width: '100%',
              height: '400px',
              objectFit: 'cover'
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr', gap: '3rem', marginBottom: '3rem' }}>
          <div>
            ...
            <p style={{ 
              ...
              Le ministère louange de MEESL est dédié à créer une atmosphère où la présence 
              de Dieu peut se manifester puissamment. À travers la musique et l'adoration, 
              nous amenons les gens à expérimenter l'intimité avec Dieu.
            </p>

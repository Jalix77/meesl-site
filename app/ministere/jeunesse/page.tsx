    ...
    <div style={{ minHeight: '100vh', background: 'var(--bgLight)', padding: '2rem 0' }}>
      ...
      <div style={{ maxWidth: '1000px', margin: '0 auto', padding: '0 2rem' }}>
        ...
        <div style={{ 
          ...
          <img 
            src="/images/Jeunesse.jpg" 
            alt="Ministère Jeunesse"
            style={{
              width: '100%',
              height: '400px',
              objectFit: 'cover'
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr', gap: '3rem', marginBottom: '3rem' }}>
          <div>
            ...
            <p style={{ 
              ...
              Le ministère jeunesse de MEESL est dédié à former, équiper et envoyer la jeune génération 
              dans leur appel divin. Nous créons un environnement où les jeunes peuvent grandir 
              dans leur foi, développer leurs talents et devenir des leaders influents dans leur communauté.
            </p>
